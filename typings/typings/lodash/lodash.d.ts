...
declare module _ {
    ...
    **/
    ...
    interface LoDashExplicitArrayWrapper<T> {
        /**
         * @see _.something else
         */
        filter(val: (val: T)=>boolean) :LoDashExplicitArrayWrapper<T>;
        sortBy(val: (val: T)=>any) :LoDashExplicitArrayWrapper<T>;
        groupBy(val: string) :LoDashExplicitArrayWrapper<T>;
    }
